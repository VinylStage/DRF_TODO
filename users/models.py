...
class UserManager(BaseUserManager):
    def create_user(self, username, introduction, email, date_of_birth, gender, password=None):
        """
    ...
    def create_superuser(self, username, email, date_of_birth, gender, introduction, password=None):
        """
...
class User(AbstractBaseUser):
    ...
    gender = models.CharField(
        choices=GenderChoices.choices, max_length=255, blank=True)
